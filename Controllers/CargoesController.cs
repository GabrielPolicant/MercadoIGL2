...
namespace MercadoIGL.Controllers
{
    public class CargoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Cargo,Nome,Salario")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Cargo,Nome,Salario")] Cargo cargo)
        {
