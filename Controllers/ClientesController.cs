...
namespace MercadoIGL.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CPF,Nome_Cliente,Endereco")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CPF,Nome_Cliente,Endereco")] Cliente cliente)
        {
            if (id != cliente.CPF)
            {
                return NotFound();
