...
namespace MercadoIGL.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        {
            ViewData["cargoID"] = new SelectList(_context.Cargos, "Id_Cargo", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CPF,Nome_Completo,Senha,cargoID")] Funcionario funcionario)
        {
            ...
            ViewData["cargoID"] = new SelectList(_context.Cargos, "Id_Cargo", "Nome", funcionario.cargoID);
            return View(funcionario);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CPF,Nome_Completo,Senha,cargoID")] Funcionario funcionario)
        {
