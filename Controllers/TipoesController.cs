...
namespace MercadoIGL.Controllers
{
    public class TipoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Tipo,TipoProduto")] Tipo tipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Tipo,TipoProduto")] Tipo tipo)
        {
            if (id != tipo.Id_Tipo)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Contexto.Tipos'  is null.");
            }
            var tipo = await _context.Tipos.FindAsync(id);
            if (tipo != null)
            {
